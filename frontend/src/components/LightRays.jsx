...
void main() {
  ...
  gl_FragColor = color;
      ...
      // window resize + container resize
      window.addEventListener("resize", updatePlacement);
      if ("ResizeObserver" in window) {
        resizeObsRef.current = new ResizeObserver(updatePlacement);
  ...
  // live-prop updates without full re-init
  useEffect(() => {
